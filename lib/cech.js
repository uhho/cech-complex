 ...
 * @return {Array}
 */
Cech.prototype.complex = function(cells) {
  this.cells = cells;
 ...
 * @return {Array}
 */
Cech.prototype.simK = function(S) {
  var k = 2;
  var i;
  var j;
  var l;
...
Cech.prototype.verify = function(u) {
  ...
  if (inside) {
    ...
    return X.some(function existsInAllCells(point) {
       return uCells.filter(
         this.isPointInsideCell.bind(this, point)
       ).length === uCells.length;
     }.bind(this));
  }
};
